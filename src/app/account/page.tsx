...
const Page = () => {
    return (
        <>
            ...
            <div className='h-[850px] md:h-[760px] px-0 md:px-32 flex flex-col md:flex-row justify-evenly items-center'>
                <div className='w-[300px] md:w-[608px] h-[630px] flex flex-col items-start justify-evenly'>
                    ...
                    <input type="text" className='h-[40px] md:h-[75px] w-[300px] md:w-[423px] outline-none border-2 border-mytextcolor rounded-md mt-3 mb-5 focus:border-myorange' />
