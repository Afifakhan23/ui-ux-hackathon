    ...
    return (
        <>
            ...
            <SignedOut>
                <div className='h-[850px] md:h-[760px] px-0 lg:px-32 flex justify-center items-center'>
                    <div className='w-[300px] lg:w-[508px] h-[600px] flex flex-col items-center justify-evenly rounded-md bg-slate-100'>
                        ...
                        <input type="text" className='h-[40px] lg:h-[75px] w-[280px] lg:w-[423px] outline-none border-2 border-mytextcolor rounded-md mt-3 mb-5 focus:border-myorange' />
            ...
            <SignedIn>
                ...
                <h2 className='text-2xl font-semibold'>Welcome to Furniora! You are now signed in and ready to explore. ✨</h2><br/>
