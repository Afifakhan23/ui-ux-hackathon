    ...
    <div className={`h-[100px] w-full ${poppins.className} bg-transparent flex justify-end items-center`}>
      ...
      <ul className="hidden lg:flex h-[28px] space-x-6 mr-0 lg:mr-20">
        ...
        <div className="relative">
          ...
          <div
            className={`fixed top-0 right-0 h-full w-80 flex flex-col justify-between bg-white shadow-lg transform transition-transform duration-300 z-50 ${
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute top-[100px] left-0 w-full bg-white text-black flex flex-col items-center space-y-6 py-6 lg:hidden">
