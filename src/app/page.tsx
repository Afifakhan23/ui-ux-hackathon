...
export default function Home() {
  ...
  return (
    <>
      <div className={`h-[60px] w-full ${poppins.className} bg-mydarkorange flex justify-between items-center z-[999]`}>
          <Link href={'/'}>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute top-[60px] w-full bg-mydarkorange text-black flex flex-col items-center space-y-6 py-6 lg:hidden">
